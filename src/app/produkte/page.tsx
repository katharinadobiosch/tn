...
export default function ProduktePage() {
  return (
    ...
    >
      ...
      <section className="bg-[#526247] px-6 py-16 text-[#FAF9F6] talbrennerei-produkte-category-navigation md:py-24">
      ...
      <section className="bg-[#FAF9F6] px-6 py-16 md:py-32">
      ...
      <section className="bg-[#EAD6BD]/35 px-6 py-20 md:py-40">
        <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2 md:gap-14">
      ...
      <section className="bg-[#EAD6BD]/35 px-6 py-16 talbrennerei-produkte-hofladen-sortiment md:py-24">
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-16 talbrennerei-produkte-seasonal md:grid-cols-[0.8fr_1.2fr] md:gap-14 md:py-20">
        <div>
          <p className="mb-4 text-xs uppercase tracking-[0.28em] text-[#526247]">
