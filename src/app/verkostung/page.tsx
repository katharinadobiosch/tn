...
export default function VerkostungPage() {
  return (
    ...
    >
      ...
      <section className="bg-[#EAD6BD] px-6 py-12 talbrennerei-verkostung-tastings md:py-36">
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-12 talbrennerei-verkostung-private-events md:grid-cols-2 md:gap-14 md:py-32">
