      ...
      <div className="grid gap-6 md:grid-cols-3">
        {categories.map((category) => (
          <Link
            key={category.title}
            href={category.href}
            className="border border-[#24231F]/15 p-8 transition-colors duration-200 hover:border-[#B87935]/45 hover:bg-[#EAD6BD]/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#1F2F20]"
          >
